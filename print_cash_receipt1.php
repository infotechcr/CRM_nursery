	...
	<div class="wrapper">
		...
		<section class="content mb-4">
			<div class="card page shadow-none m-2">
				...
				<?php while($slip_rows = mysqli_fetch_assoc($pay_slip_expenses_data)) { $test = convert_number_to_words($slip_rows["amount"]); $date_demo = explode('-',$slip_rows['date']); ?>
				<!-- Receipt 1 -->
						<div class="card-body myTableBg4 p-0 mb-5">
							...
							<div class="p-3">
								<table width="100%" class="mb-3">
									<tr>
										<td width="50%">
											<h5 class="profile-username font-weight-bold">Date : <span class=""><?php echo $date_demo[2].'-'.$date_demo[1].'-'.$date_demo[0]; ?></span></h5>
										</td>
										<td width="50%" align="right">
											<h5 class="profile-username font-weight-bold">Receipt No. : <span class=""><?php echo $slip_rows['e_id']; ?></span></h5>
										</td>
									</tr>
								</table>
								<table class="table mb-0" align="center">							
									<tr>
										<td colspan="2">                              
											<h5 class="profile-username font-weight-bold">
												M/s : 
												<span class="font-weight-normal"><?php echo $slip_rows['e_name']; ?></span>
											</h5>
										</td>
									</tr>
									<tr>
										<td colspan="2">                              
											<h5 class="profile-username font-weight-bold">
												Cheque / Cash : 
												<span class="font-weight-normal"><?php if($slip_rows['mode']==1) { echo "BY UPI"; }else if($slip_rows['mode']==2) { echo "BY Bank Transfer"; }else if($slip_rows['mode']==3) { echo "BY Cheque"; }else{ echo "BY Cash "; } ?></span>
											</h5>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<h5 class="profile-username font-weight-bold text-left">
												Detail : 
												<span class="font-weight-normal"><?php echo $slip_rows['note']; ?></span>
											</h5>
										</td>    
									</tr>
									<tr>
